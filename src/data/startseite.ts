...
export interface Teammitglied {
  ...
  /** Art der Zusammenarbeit, steht vor der Rolle — z. B. „Freelancer".
      Zurzeit ungenutzt: „Freelancer" stand bis zum 16.09.2026 unter jedem
      der drei Namen und ist auf Wunsch von Iwo wieder raus. Das Feld
      bleibt, weil die Unterscheidung wiederkommen kann. */
  art?: string;
