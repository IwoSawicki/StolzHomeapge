...
| 18 | Hero-Variante 2 „Shape-Überlappung": großes Hochkant-Video (500px) rechts, weißes Text-Panel überlappt am Desktop 112px ins Video — Shape-typische Außenrundungen (konvexe Panel-Kante `rounded-r-[32px]` + umgekehrte 24px-Kurven oben/unten via Radial-Gradient-Pseudo-Elemente); Eyebrow „Hey, wir sind Stolz Marketing", Headline „Ein Ansprechpartner für Ihr gesamtes Marketing." | Auftrag Iwo (Juli 2026), zur Auswahl unter Variante 1 |
