...
| 24 | Über-uns-Kurzsektion (id="ueber-uns", Ziel des Hero-Buttons): Eyebrow links + großes Statement (44px, zweiter Teil grau) im Shape/Rebland-Stil — TEXT = VORSCHLAG; Startseiten-Reihenfolge neu: Hero → Über uns → Projekte → Rest; Header-/Footer-Navigation: „Projekte" (→ /projekte) zuerst, „Startseite"-Link entfällt (Logo verlinkt auf /), „Über uns" (→ /#ueber-uns) ergänzt; v2-Video auf 720px verbreitert | Auftrag Iwo (Juli 2026) |
