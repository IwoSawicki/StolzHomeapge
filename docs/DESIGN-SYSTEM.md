...
| 21 | Hero-Variante 4 „Skizze": 1:1-Video (580px) rechts, Treppen-Headline schneidet von links hinein (Geometrie: Text-Einzug 340px, Videokante bei 620px im 1200er-Container — bei Textänderungen nachmessen); mobil Text oben + Hochkant-Video (gleiche Datei, object-cover) | Skizze Iwo (Juli 2026), zur Auswahl unter Variante 3 |
