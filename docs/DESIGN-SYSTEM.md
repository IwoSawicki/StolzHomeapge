...
| 20 | CTAs aller drei Hero-Varianten: „Projekte ansehen" (→ /projekte) + „Über uns" (Anker `#ueber-uns`, Ziel folgt mit der Über-uns-Sektion) statt Potenzial-Check/Anruf | Auftrag Iwo (Juli 2026) |
