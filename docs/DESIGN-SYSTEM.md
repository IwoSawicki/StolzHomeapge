...
| 19 | Hero-Variante 3 „Shape-Treppe": dunkle Canvas-Fläche, Eyebrow/Headline-Zeilen/Buttons als treppenartig gestufte weiße Blöcke mit umgekehrten Kurven an jedem Absatz (pures CSS, manuelle Zeilenumbrüche mit fester Breiten-Reihenfolge); Hochkant-Video rechts in der Fläche, Statement unten links; Headline mobil text-3xl statt text-34 (Passung 390px) | Auftrag Iwo (Juli 2026), zur Auswahl unter Variante 2 |
