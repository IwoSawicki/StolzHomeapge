...
| 18 | Hero-Variante 2 „Shape-Überlappung" (aktuell erste Sektion): Hochkant-Kachel (540px, rechts bündig mit Kontakt-Button via flex-1-Panel) mit Shape-Showreel als stummem Endlos-Loop (1920×1080, object-cover-Beschnitt); Text-Panel überlappt 112px mit Außenrundungen; Eyebrow „Hallo, wir sind STOLZ 👋" + Headline „Mehr Anfragen… Messbar & Planbar."; Klick auf „Einblick in unsere Arbeit" öffnet Showreel-Overlay (backdrop-blur über der Seite, Video mittig, Ton von Anfang, Schließen via X/Hintergrund/Escape, Body-Scroll-Lock) | Auftrag Iwo (Juli 2026) |
| 19 | Hero-Variante 3 „Shape-Treppe": dunkle Canvas-Fläche, Eyebrow/Headline-Zeilen/Buttons als treppenartig gestufte weiße Blöcke mit umgekehrten Kurven an jedem Absatz (pures CSS, manuelle Zeilenumbrüche mit fester Breiten-Reihenfolge); Statement unten links, „Einblick"-Pill unten rechts; Headline mobil text-3xl statt text-34 (Passung 390px); Quer-Video als Flächen-Hintergrund automatisch, sobald `public/videos/hero-quer.mp4` existiert | Auftrag Iwo (Juli 2026), zur Auswahl unter Variante 2 |
| 20 | CTAs aller Hero-Varianten: „Projekte ansehen" (→ /projekte) + „Über uns" (Anker `#ueber-uns`, Ziel folgt mit der Über-uns-Sektion) statt Potenzial-Check/Anruf | Auftrag Iwo (Juli 2026) |
| 21 | Hero-Variante 4 „Skizze": volle Breite, Text bündig links (Einzug 64px), Video rechts mit fixer Breite 50 % über die volle Hero-Höhe (min-h-svh); Treppen-Stufen mit festen Mindestbreiten (50 % + 180/90/24/64px) — Treppe damit unabhängig von Textlängen auf jeder Viewport-Breite identisch; Headline xl:text-7xl; mobil Text oben + Hochkant-Video | Skizze Iwo (Juli 2026), Nachschärfung „füllender" |
| 24 | Über-uns-Kurzsektion (id="ueber-uns", Ziel des Hero-Buttons), Rebland-inspiriert in STOLZ-CI: blaue Fläche (bg-blue-light, Radius 32), Statement mit blauen Akzent-Wörtern, links Kurztexte, rechts Leistungsliste mit blauen Pfeil-Kreisen (Leistungen aus der Hero-Subline hierher verschoben) — TEXTE = VORSCHLAG; Startseiten-Reihenfolge: Hero → Über uns → Projekte → Rest; Header-/Footer-Navigation: „Projekte" (→ /projekte) zuerst, „Startseite"-Link entfällt (Logo verlinkt auf /), „Über uns" (→ /#ueber-uns) ergänzt | Auftrag Iwo (Juli 2026) |
| 25 | Hero final = ehem. Variante 2: Headline ist jetzt der echte `<h1>` („Volle Auftragsbücher. Passende Bewerber.", 52px), Eyebrow „Hey, wir sind Stolz Marketing 👋" (text-base), Video-Kachel 720px breit × 80vh hoch (object-cover); übrige Hero-Varianten (v4/v1/v3 + alte Original-Hero) von der Startseite ins Archiv /projekte-2 verschoben | Auftrag Iwo (Juli 2026) |
| 26 | Website-Kacheln als CSS-Mockups (`BrowserMockup mockup`): Browser-Fenster (Mac-Dots + Domain-Pill, shadow-stack-strong, Ring) schwebt auf Farbfläche (bg-blue→bg-blue-light) und ist unten angeschnitten — gilt automatisch für alle Website-Projekte im Grid | Auftrag Iwo (Juli 2026), „Mockup statt roher Screenshot" |
| 27 | Leistungs-Sektion „Expertise", volle Breite auf schwarzer Fläche (Nachbau Shape „Our Expertise", id="leistungen"): Kopf dreispaltig, Leistungen als riesige Zeilen (Webseiten · Google Ads & SEO · KI-Ranking · Social Media Ads · Recruiting-Kampagnen · Video- & Content-Produktion); Hover: aktive Zeile leuchtet, Rest dimmt, blauer Pfeil-Kreis folgt der Maus (Vanilla-JS wie Projekt-Grid, `cursor:none` auf Zeilen); Zeilen unverlinkt bis /leistungen/[slug] existiert; Über-uns-Liste angeglichen. Mobil/Tablet: kleines Bild (56px) dauerhaft links (wie Shape) + kurze Labels (Google Ads · Social Ads · Recruiting · Foto & Video); Desktop: Hover-Vorschaubild wächst von Breite 0 auf, Text weicht aus, kein Fade. Content auf Seitenbreite (max-w-1200, bündig mit Header), schwarze Fläche randlos. „Ihre Herausforderungen" (Painpoint-Tabs) und „Warum wir?" (id=warum-wir) von der Startseite ins Archiv /projekte-2 verschoben | Auftrag Iwo (Juli 2026) |
| 23 | Projekt-Unterseiten /projekte/[slug] (alle 8 Projekte, Daten aus src/data/projekte.ts): Kopf (Pills, H1, Einleitung, 4 Keyfacts), Medien (Website: großes Browser-Mockup / Video: 3 Dreh-Kacheln), „Was wir umgesetzt haben" (Bild links, 4 Bullet-Points rechts), nur Websites: Seitenstruktur-Karten, Ergebnisse (3 Zahlen-Karten, Werte „XX" = Platzhalter von Iwo zu befüllen) + CTA; Grid-Karten verlinken auf die Unterseiten | Auftrag Iwo (Juli 2026), Texte = Vorschläge |
| 22 | Projekt-Design ENTSCHIEDEN: „Shape" (ehem. Variante C) auf Startseite (id="projekte") und /projekte, gemeinsames `ProjekteGrid`; Kategorie-Pills dauerhaft sichtbar (nicht nur Hover); Hover-Cursor in CI-Blau (--color-blue) mit weißem Pfeil; nicht gewählte Grids (A/B/D/E + alte 1:1-Sektion) archiviert unter /projekte-2 (robots.txt Disallow + Sitemap-Filter) | Auftrag Iwo (Juli 2026) |
