...
| 27 | Leistungs-Sektion „Expertise" auf dunkler Fläche (Nachbau Shape „Our Expertise", id="leistungen" — alte Karten-Sektion umbenannt zu id="warum-wir"): Kopf dreispaltig, Leistungen als riesige Zeilen (Webseiten · Google Ads & SEO · KI-Ranking · Social Media Ads · Recruiting-Kampagnen · Video- & Content-Produktion) mit Schwerpunkt-Tag rechts (Kundengewinnung/Mitarbeitergewinnung); Hover: Zeile leuchtet, Rest dimmt, Projekt-Vorschau + blauer Pfeil-Kreis (pures CSS); Zeilen unverlinkt bis /leistungen/[slug] existiert; Über-uns-Liste angeglichen („Webseiten", + „KI-Ranking") | Auftrag Iwo (Juli 2026) |
